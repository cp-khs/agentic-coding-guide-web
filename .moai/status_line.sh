...
if [ -f "/Users/khs/go/bin/moai" ]; then
	exec "/Users/khs/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/khs/.local/bin/moai" ]; then
	exec "/Users/khs/.local/bin/moai" statusline < "$temp_file"
fi
